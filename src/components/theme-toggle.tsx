    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="outline" size="icon" className="rounded-full bg-white/70 dark:bg-slate-900/70 border-white dark:border-slate-800 shadow-sm backdrop-blur-xl transition-all">
            ...
            <DropdownMenuContent align="end" className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-white dark:border-slate-800">
