                                ...
                                <div className="grid grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_110px_120px_auto] sm:items-center">
                                    ...
                                    <div className="flex items-center gap-1 justify-self-start sm:justify-self-end">
                                        <AssetPacModal
                                            ...
                                            trigger={
                                                <Button
                                                    ...
                                                    className="h-11 w-11 rounded-full text-emerald-600 transition-colors hover:bg-emerald-50 hover:text-emerald-700 disabled:opacity-40 dark:text-emerald-300 dark:hover:bg-emerald-950/50"
                                                    aria-label="Configura PAC automatico"
                                                    title="Configura PAC automatico"
                                                >
                                            ...
                                            <SaleTaxModal
                                                ...
                                                trigger={
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
                                                        className="h-11 w-11 rounded-full text-violet-500 transition-colors hover:bg-violet-50 hover:text-violet-700 dark:text-violet-300 dark:hover:bg-violet-950/50"
                                        ...
                                        <Button
                                            variant="ghost"
                                            size="icon"
                                            className="h-11 w-11 rounded-full text-rose-500 transition-colors hover:bg-rose-50 hover:text-rose-700 dark:text-rose-300 dark:hover:bg-rose-950/50"
                                            onClick={() => {
