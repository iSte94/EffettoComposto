                ...
                <CardContent className="p-4 sm:p-6">
                    <div className="mb-5 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-3">
                            <div className="rounded-xl border border-blue-100 bg-blue-50 p-2 text-blue-600 dark:border-blue-900 dark:bg-blue-950/50 dark:text-blue-400">
                                <Wallet className="h-5 w-5" />
                            </div>
                            <div>
                                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900 dark:text-slate-100">Profilo Finanziario</h3>
                                <p className="mt-0.5 text-[10px] font-semibold uppercase tracking-widest text-slate-500 dark:text-slate-400">Entrate, Uscite e Risparmio</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-5 flex items-center justify-between gap-2 rounded-xl border border-blue-100 bg-blue-50 px-3 py-3 dark:border-blue-900 dark:bg-blue-950/50">
                        <span className="text-xs font-bold uppercase tracking-wider text-blue-700 dark:text-blue-300">Reddito Lordo Familiare</span>
                    ...
                    <div className="mb-4 border-t border-slate-100 pt-4 dark:border-slate-800">
                        ...
                        {manualExpenses > 0 && (
                            <div className="mt-2 flex items-center justify-between rounded-xl bg-slate-50 px-3 py-2 text-slate-500 dark:bg-slate-800/50 dark:text-slate-400">
                    ...
                    <div className="mb-4 flex items-center justify-between gap-3 rounded-xl border border-rose-100 bg-rose-50 px-3 py-3 dark:border-rose-900 dark:bg-rose-950/50">
                        <span className="text-xs font-bold uppercase tracking-wider text-rose-700 dark:text-rose-300">Totale Spese</span>
                        <span className="text-lg font-black tabular-nums text-rose-500">-{formatEuro(totalExpenses)}/mese</span>
                    </div>

                    <div className={`flex items-center justify-between gap-3 rounded-xl border px-4 py-3 ${netIncome >= 0 ? "border-emerald-100 bg-emerald-50 dark:border-emerald-900 dark:bg-emerald-950/50" : "border-rose-100 bg-rose-50 dark:border-rose-900 dark:bg-rose-950/50"}`}>
                        <div>
                            ...
                            <p className="mt-0.5 text-[10px] text-slate-400 dark:text-slate-400">Reddito familiare - spese personali - immobili - prestiti</p>
                        </div>
