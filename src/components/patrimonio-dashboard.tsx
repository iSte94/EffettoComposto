...
export function PatrimonioDashboard({ user }: PatrimonioDashboardProps) {
    ...
    const quickActionClass =
        "group h-auto min-h-14 justify-between rounded-2xl border border-slate-200/80 bg-white/80 px-4 py-3 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800/70 dark:hover:border-slate-600";
                    ...
                    <div className="rounded-[2rem] border border-slate-200/80 bg-white/80 p-3 shadow-lg backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/80">
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            ...
                            <TabsList className="grid w-full grid-cols-2 gap-2 border-none bg-transparent p-0 md:w-auto md:grid-cols-4">
                                <TabsTrigger value="overview" className={mainSectionTriggerClass}><div className="flex flex-col items-start gap-1"><span className="flex items-center gap-2 text-sm font-semibold"><LayoutDashboard className="size-4" /> Panoramica</span><span className="hidden text-xs opacity-80 md:block">Salute finanziaria e azioni rapide</span></div></TabsTrigger>
                                <TabsTrigger value="asset" className={mainSectionTriggerClass}><div className="flex flex-col items-start gap-1"><span className="flex items-center gap-2 text-sm font-semibold"><HomeIcon className="size-4" /> Asset</span><span className="hidden text-xs opacity-80 md:block">Immobili, investimenti e altre attivita</span></div></TabsTrigger>
                                <TabsTrigger value="cashflow" className={mainSectionTriggerClass}><div className="flex flex-col items-start gap-1"><span className="flex items-center gap-2 text-sm font-semibold"><CreditCard className="size-4" /> Passivita & Cashflow</span><span className="hidden text-xs opacity-80 md:block">Debiti, entrate, uscite e risparmio</span></div></TabsTrigger>
                                <TabsTrigger value="history" className={mainSectionTriggerClass}><div className="flex flex-col items-start gap-1"><span className="flex items-center gap-2 text-sm font-semibold"><History className="size-4" /> Storico</span><span className="hidden text-xs opacity-80 md:block">Grafico e snapshot salvati</span></div></TabsTrigger>
                            </TabsList>
                        </div>
                    </div>
                </div>
                            ...
                            <Card className="overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/80 shadow-lg backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/80">
                                ...
                                <CardContent className="space-y-5 p-6">
                                    <div className="grid gap-3 sm:grid-cols-2">
                                        <Button variant="ghost" className={quickActionClass} onClick={() => { setActivePatrimonioTab("asset"); setActiveAssetSubTab("realestate"); }}><span className="flex items-center gap-3"><span className="rounded-2xl bg-emerald-50 p-2 text-emerald-600 dark:bg-emerald-950/50 dark:text-emerald-300"><HomeIcon className="size-4" /></span><span className="flex flex-col items-start"><span className="text-sm font-semibold text-slate-900 dark:text-slate-100">Aggiorna immobili</span><span className="text-xs text-slate-500 dark:text-slate-400">Valori, costi, affitti e mutui collegati</span></span></span><ArrowRight className="size-4 text-slate-400 transition-transform group-hover:translate-x-0.5" /></Button>
                                        <Button variant="ghost" className={quickActionClass} onClick={() => { setActivePatrimonioTab("asset"); setActiveAssetSubTab("investments"); }}><span className="flex items-center gap-3"><span className="rounded-2xl bg-purple-50 p-2 text-purple-600 dark:bg-purple-950/50 dark:text-purple-300"><PiggyBank className="size-4" /></span><span className="flex flex-col items-start"><span className="text-sm font-semibold text-slate-900 dark:text-slate-100">Aggiorna investimenti</span><span className="text-xs text-slate-500 dark:text-slate-400">ETF, azioni, liquidita e fondo emergenza</span></span></span><ArrowRight className="size-4 text-slate-400 transition-transform group-hover:translate-x-0.5" /></Button>
                                        <Button variant="ghost" className={quickActionClass} onClick={() => setActivePatrimonioTab("cashflow")}><span className="flex items-center gap-3"><span className="rounded-2xl bg-rose-50 p-2 text-rose-600 dark:bg-rose-950/50 dark:text-rose-300"><CreditCard className="size-4" /></span><span className="flex flex-col items-start"><span className="text-sm font-semibold text-slate-900 dark:text-slate-100">Gestisci debiti</span><span className="text-xs text-slate-500 dark:text-slate-400">Prestiti, rate e profilo di spesa familiare</span></span></span><ArrowRight className="size-4 text-slate-400 transition-transform group-hover:translate-x-0.5" /></Button>
                                        <Button variant="ghost" className={quickActionClass} onClick={() => setActivePatrimonioTab("history")}><span className="flex items-center gap-3"><span className="rounded-2xl bg-amber-50 p-2 text-amber-600 dark:bg-amber-950/50 dark:text-amber-300"><History className="size-4" /></span><span className="flex flex-col items-start"><span className="text-sm font-semibold text-slate-900 dark:text-slate-100">Apri storico</span><span className="text-xs text-slate-500 dark:text-slate-400">Grafico e modifica rapida degli snapshot salvati</span></span></span><ArrowRight className="size-4 text-slate-400 transition-transform group-hover:translate-x-0.5" /></Button>
                                    </div>
