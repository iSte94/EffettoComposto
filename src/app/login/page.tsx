      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="rounded-3xl border border-border bg-background/80 shadow-xl backdrop-blur-2xl">
          <CardHeader className="space-y-1 pb-4 text-center">
            <CardTitle className="text-xl font-bold">{isLogin ? "Accedi" : "Crea un Account"}</CardTitle>
            <CardDescription>
              {isLogin
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                <Button
                  type="submit"
                  disabled={loading}
                  className="min-h-11 w-full bg-blue-600 text-white shadow-md hover:bg-blue-700"
                >
                ...
                <Button
                  ...
                  className="min-h-11 w-full text-muted-foreground hover:bg-muted hover:text-foreground"
                >
